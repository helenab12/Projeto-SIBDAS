...
(1,  'Equipamento',           1,  'Criação', NULL,            NULL,           NULL,              '2024-03-15 10:00:00'),
(1,  'Pessoa',                6,  'Criação', NULL,            NULL,           NULL,              '2024-03-01 09:25:00'),
(2,  'Manutencao',            1,  'Criação', NULL,            NULL,           NULL,              '2025-03-01 08:00:00'),
(1,  'Utilizador',            8,  'Edição',  'estado',        'Ativo',        'Inativo',         '2025-06-01 14:00:00'),
(2,  'Equipamento',           1,  'Edição',  'estadoAtual',   'Ativo',        'Em manutenção',   '2025-11-15 09:00:00'),
(2,  'Equipamento',           1,  'Edição',  'designacao',    'RX Portátil',  'Aparelho de Raio-X Digital Portátil', '2025-11-15 09:00:00'),
(1,  'Fornecedor',            5,  'Criação', NULL,            NULL,           NULL,              '2024-04-01 10:20:00'),
(3,  'Manutencao',            1,  'Edição',  'dataFim',       NULL,           '2025-09-12',      '2025-09-12 15:00:00'),
(1,  'Equipamento',           10, 'Edição',  'arquivado',     '0',            '1',               '2025-10-01 16:00:00'),
(2,  'Documento',             1,  'Criação', NULL,            NULL,           NULL,              '2025-01-10 11:00:00'),
(1,  'FornecedorEquipamento', 1,  'Criação', 'idFornecedor',  NULL,           '5',               '2024-04-01 10:20:00'),
(1,  'Perfil',                5,  'Edição',  'nome',          'Visualização', 'Consulta',        '2024-06-01 10:00:00'),
(2, 'Equipamento', 1, 'Criação', NULL, NULL, NULL, '2024-06-15 10:00:00'),
(3, 'Equipamento', 1, 'Edição', 'estadoAtual', 'Ativo', 'Em manutenção', '2025-02-11 14:00:00'),
(2, 'Equipamento', 1, 'Edição', 'designacao', 'Equip. Velho', 'Novo Equip.', '2025-06-27 14:00:00'),
(3, 'GarantiaContrato', 1, 'Remoção', NULL, NULL, NULL, '2025-02-20 14:00:00'),
(2, 'Equipamento', 1, 'Edição', 'codigoInterno', 'COD-001', 'COD-001-NEW', '2025-06-23 14:00:00'),
(1, 'Equipamento', 2, 'Criação', NULL, NULL, NULL, '2024-01-15 10:00:00'),
(2, 'Equipamento', 2, 'Edição', 'estadoAtual', 'Ativo', 'Em manutenção', '2025-02-12 14:00:00'),
(2, 'Equipamento', 2, 'Edição', 'designacao', 'Equip. Velho', 'Novo Equip.', '2025-05-20 14:00:00'),
(3, 'GarantiaContrato', 2, 'Remoção', NULL, NULL, NULL, '2025-01-19 14:00:00'),
(2, 'Equipamento', 2, 'Edição', 'codigoInterno', 'COD-001', 'COD-001-NEW', '2025-06-23 14:00:00'),
(2, 'Equipamento', 3, 'Criação', NULL, NULL, NULL, '2024-04-15 10:00:00'),
(2, 'Equipamento', 3, 'Edição', 'estadoAtual', 'Ativo', 'Em manutenção', '2025-08-15 14:00:00'),
(3, 'Equipamento', 3, 'Edição', 'designacao', 'Equip. Velho', 'Novo Equip.', '2025-08-14 14:00:00'),
(1, 'GarantiaContrato', 3, 'Remoção', NULL, NULL, NULL, '2025-05-10 14:00:00'),
(3, 'Equipamento', 3, 'Edição', 'codigoInterno', 'COD-001', 'COD-001-NEW', '2025-06-21 14:00:00'),
(3, 'Equipamento', 4, 'Criação', NULL, NULL, NULL, '2024-07-15 10:00:00'),
(2, 'Equipamento', 4, 'Edição', 'estadoAtual', 'Ativo', 'Em manutenção', '2025-08-10 14:00:00'),
(3, 'Equipamento', 4, 'Edição', 'designacao', 'Equip. Velho', 'Novo Equip.', '2025-04-25 14:00:00'),
(3, 'GarantiaContrato', 4, 'Remoção', NULL, NULL, NULL, '2025-05-23 14:00:00'),
(1, 'Equipamento', 4, 'Edição', 'codigoInterno', 'COD-001', 'COD-001-NEW', '2025-02-27 14:00:00'),
(1, 'Equipamento', 5, 'Criação', NULL, NULL, NULL, '2024-03-15 10:00:00'),
(3, 'Equipamento', 5, 'Edição', 'estadoAtual', 'Ativo', 'Em manutenção', '2025-03-25 14:00:00'),
(1, 'Equipamento', 5, 'Edição', 'designacao', 'Equip. Velho', 'Novo Equip.', '2025-01-10 14:00:00'),
(3, 'GarantiaContrato', 5, 'Remoção', NULL, NULL, NULL, '2025-08-14 14:00:00'),
(1, 'Equipamento', 5, 'Edição', 'codigoInterno', 'COD-001', 'COD-001-NEW', '2025-06-21 14:00:00'),
(2, 'Equipamento', 6, 'Criação', NULL, NULL, NULL, '2024-08-15 10:00:00'),
(2, 'Equipamento', 6, 'Edição', 'estadoAtual', 'Ativo', 'Em manutenção', '2025-03-20 14:00:00'),
(3, 'Equipamento', 6, 'Edição', 'designacao', 'Equip. Velho', 'Novo Equip.', '2025-03-16 14:00:00'),
(3, 'GarantiaContrato', 6, 'Remoção', NULL, NULL, NULL, '2025-05-22 14:00:00'),
(3, 'Equipamento', 6, 'Edição', 'codigoInterno', 'COD-001', 'COD-001-NEW', '2025-07-27 14:00:00'),
(2, 'Equipamento', 7, 'Criação', NULL, NULL, NULL, '2024-03-15 10:00:00'),
(1, 'Equipamento', 7, 'Edição', 'estadoAtual', 'Ativo', 'Em manutenção', '2025-07-26 14:00:00'),
(1, 'Equipamento', 7, 'Edição', 'designacao', 'Equip. Velho', 'Novo Equip.', '2025-09-17 14:00:00'),
(1, 'GarantiaContrato', 7, 'Remoção', NULL, NULL, NULL, '2025-02-23 14:00:00'),
(1, 'Equipamento', 7, 'Edição', 'codigoInterno', 'COD-001', 'COD-001-NEW', '2025-01-26 14:00:00'),
(3, 'Equipamento', 8, 'Criação', NULL, NULL, NULL, '2024-05-15 10:00:00'),
(3, 'Equipamento', 8, 'Edição', 'estadoAtual', 'Ativo', 'Em manutenção', '2025-01-25 14:00:00'),
(3, 'Equipamento', 8, 'Edição', 'designacao', 'Equip. Velho', 'Novo Equip.', '2025-09-22 14:00:00'),
(1, 'GarantiaContrato', 8, 'Remoção', NULL, NULL, NULL, '2025-08-20 14:00:00'),
(2, 'Equipamento', 8, 'Edição', 'codigoInterno', 'COD-001', 'COD-001-NEW', '2025-09-21 14:00:00'),
(3, 'Equipamento', 9, 'Criação', NULL, NULL, NULL, '2024-04-15 10:00:00'),
(1, 'Equipamento', 9, 'Edição', 'estadoAtual', 'Ativo', 'Em manutenção', '2025-01-17 14:00:00'),
(1, 'Equipamento', 9, 'Edição', 'designacao', 'Equip. Velho', 'Novo Equip.', '2025-04-10 14:00:00'),
(2, 'GarantiaContrato', 9, 'Remoção', NULL, NULL, NULL, '2025-09-11 14:00:00'),
(2, 'Equipamento', 9, 'Edição', 'codigoInterno', 'COD-001', 'COD-001-NEW', '2025-08-21 14:00:00'),
(3, 'Equipamento', 10, 'Criação', NULL, NULL, NULL, '2024-05-15 10:00:00'),
(1, 'Equipamento', 10, 'Edição', 'estadoAtual', 'Ativo', 'Em manutenção', '2025-07-17 14:00:00'),
(1, 'Equipamento', 10, 'Edição', 'designacao', 'Equip. Velho', 'Novo Equip.', '2025-06-27 14:00:00'),
(3, 'GarantiaContrato', 10, 'Remoção', NULL, NULL, NULL, '2025-09-20 14:00:00'),
(2, 'Equipamento', 10, 'Edição', 'codigoInterno', 'COD-001', 'COD-001-NEW', '2025-02-15 14:00:00');
