    ...
    <div class="d-flex flex-column gap-6 w-100">
        ...
        <div class="card bento-card padding-6 d-flex flex-column gap-4">
            ...
            <?php if (count($documentos) === 0): ?>
                <div class="d-flex flex-column align-items-center justify-content-center padding-8 gap-3 text-secondary opacity-75"
                    style="background-color: var(--grey-100); border-radius: var(--radius-md);">
                    ...
                    <p class="m-0 fw-500">Nenhum documento associado a este equipamento.</p>
                </div>
            <?php else: ?>
