                    ...
                    <form id="person-creation-form" method="POST" action="people-crud/create-person.php"
                        ...
                        <div class="d-flex gap-4 w-100">
                            ...
                            <div class="d-flex flex-column form-item w-100 mw-0">
                                ...
                                <!-- Input -->
                                <input type="text" id="person-nif" name="person-nif" placeholder="Ex: 123456789"
                            ...
                            <div class="d-flex w-100 gap-4">
                                ...
                                <div class="d-flex flex-column form-item w-100 mw-0">
                                    ...
                                    <input type="text" id="edit-person-nif-<?= htmlspecialchars($encryptedPersonId) ?>"
                                        name="person-nif" maxlength="9" value="<?= htmlspecialchars($pessoa->getNif()) ?>"
                                        required>
                                </div>
                            </div>
                    ...
                    <div
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <h2 class="equipment-creation-modal-title modal-title"
                                ...
                                Eliminar Utilizador</h2>
                            <!-- Texto -->
                            <span class="text-secondary fw-400">O utilizador será movido para a reciclagem.</span>
                        </div>
