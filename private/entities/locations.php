        ...
        <div
            ...
            <form action="" class="flex-grow-1">
                <div class="form-item w-100 position-relative">
                    ...
                    <!-- Input -->
                    <input type="search" name="search" class="form-item w-100 search-bar-input"
                        placeholder="Pesquisar edificios..." value="<?= htmlspecialchars($search_query) ?>">
                </div>
            </form>
        </div>
                            ...
                            <div class="d-flex flex-column gap-3 locations">
                                <div class="card bento-card d-flex flex-column align-items-start overflow-hidden">
                                    <div class="d-flex justify-content-between w-100 pe-4 align-items-center location-row building-row">
                                        <div class="btn btn-link text-decoration-none mw-0 d-flex flex-grow-1 accordion-button bg-transparent  top-level level-1 collapsed"
                                            ...
                                            <?php foreach ($edificio->getPisos() as $piso): ?>
                                                    ...
                                                    <div class="d-flex flex-column w-100">
                                                        <div class="d-flex justify-content-between w-100 pe-4 align-items-center location-row">
                                                            <div class="btn btn-link text-decoration-none mw-0 d-flex flex-grow-1 accordion-button bg-transparent  level-2 collapsed"
                                                                data-bs-toggle="collapse"
                                                                ...
                                                                <div class="d-flex gap-3 align-items-center">
                                                                    ...
                                                                    <div
                                                                        class="table-icon-wrapper padding-2 d-flex align-items-center justify-content-center flex-shrink-0 floor-icon-wrapper">
                                                                        <!-- SVG -->
                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                                ...
                                                                <?php foreach ($piso->getServicos() as $servico): ?>
                                                                        ...
                                                                        <div class="d-flex flex-column w-100">
                                                                            <div
                                                                                ...
                                                                                <div class="btn btn-link text-decoration-none mw-0 d-flex flex-grow-1 accordion-button bg-transparent  level-3 collapsed"
                                                                                    data-bs-toggle="collapse"
                                                                                    ...
                                                                                    <div class="d-flex gap-3 align-items-center">
                                                                                        ...
                                                                                        <div
                                                                                            class="table-icon-wrapper padding-2 d-flex align-items-center justify-content-center flex-shrink-0 text-success">
                                                                                            <!-- SVG -->
                                                                                ...
                                                                                <div class="d-flex flex-column gap-2 collapse-inner-level">
                                                                                    ...
                                                                                    <?php foreach ($servico->getSalas() as $sala): ?>
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div class="d-flex gap-3 align-items-center">
                                                                                                    <div
                                                                                                        class="table-icon-wrapper padding-2 d-flex align-items-center justify-content-center flex-shrink-0 text-secondary">
                                                                                                        <!-- SVG -->
                                                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20"
                                                                                                            height="20" viewBox="0 0 24 24" fill="none"
                                                                                                            stroke="currentColor" stroke-width="2"
                            ...
                            <?php if (SHOW_DEBUG_BUTTONS): ?>
                                    <div class="d-flex flex-wrap gap-2 pt-2 border-top border-light mt-4">
                                        ...
                                        <button type="button" class="btn btn-primary-outline btn-small fw-700 flex-grow-1"
                                            onclick="prefillFields({'building-name': 'Edifício D'}); setTimeout(() => { document.getElementById('building-name').dispatchEvent(new Event('input', { bubbles: true })); }, 100);">Edifício
                                            D</button>
                                        <!-- Botão -->
                                        <button type="button" class="btn btn-primary-outline btn-small fw-700 flex-grow-1"
                                            onclick="prefillFields({'building-name': 'Edifício E'}); setTimeout(() => { document.getElementById('building-name').dispatchEvent(new Event('input', { bubbles: true })); }, 100);">Edifício
                                            E</button>
                                    </div>
                            <?php endif; ?>
                        </form>
                            ...
                            <div
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <h2 class="equipment-creation-modal-title modal-title"
                                        ...
                                        Eliminar Edifício</h2>
                                    <!-- Texto -->
                                    <span class="text-secondary fw-400">O edifício será movido para a reciclagem.</span>
                                </div>
                                            ...
                                            <div class="d-flex flex-column align-items-center justify-content-center gap-3">
                                                <div
                                                    ...
                                                    <p class="text-secondary">
                                                        ...
                                                        o edifício e todo o seu conteúdo?
                                                    </p>
                                                    <!-- Título -->
                                                    <h2 class="fw-700">
                                                        "<?= htmlspecialchars($edificio->getNome()) ?>"
                                ...
                                <form method="POST" action="locations-crud/create-floor.php"
                                    ...
                                    <?php if (SHOW_DEBUG_BUTTONS): ?>
                                            <div class="d-flex flex-wrap gap-2 pt-2 border-top border-light mt-4">
                                                ...
                                                <!-- Botão -->
                                                <button type="button" class="btn btn-primary-outline btn-small fw-700 flex-grow-1"
                                                    onclick="prefillFields({'floor-name-create-<?= htmlspecialchars($encryptedEdificioId) ?>': 'Piso 1'}); setTimeout(() => { document.getElementById('floor-name-create-<?= htmlspecialchars($encryptedEdificioId) ?>').dispatchEvent(new Event('input', { bubbles: true })); }, 100);">Piso
                                                    1</button>
                                                <!-- Botão -->
                                                <button type="button" class="btn btn-primary-outline btn-small fw-700 flex-grow-1"
                                                    onclick="prefillFields({'floor-name-create-<?= htmlspecialchars($encryptedEdificioId) ?>': 'Piso 2'}); setTimeout(() => { document.getElementById('floor-name-create-<?= htmlspecialchars($encryptedEdificioId) ?>').dispatchEvent(new Event('input', { bubbles: true })); }, 100);">Piso
                                                    2</button>
                                            </div>
                                    <?php endif; ?>
                                </form>
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <h2 class="equipment-creation-modal-title modal-title"
                                                ...
                                                Eliminar Piso</h2>
                                            <!-- Texto -->
                                            <span class="text-secondary fw-400">O piso será movido para a reciclagem.</span>
                                        </div>
                                                ...
                                                <div class="d-flex flex-column align-items-center gap-4">
                                                    ...
                                                    <div class="d-flex flex-column align-items-center justify-content-center gap-3">
                                                        <div
                                                            ...
                                                            <!-- Parágrafo -->
                                                            <p class="text-secondary">
                                                                Tem a certeza que deseja apagar o piso e todo o seu
                                                                conteúdo?
                                                            </p>
                                                            <!-- Título -->
                                                            <h2 class="fw-700">
                                        ...
                                        <form method="POST" action="locations-crud/create-service.php"
                                            ...
                                            <?php if (SHOW_DEBUG_BUTTONS): ?>
                                                    <div class="d-flex flex-wrap gap-2 pt-2 border-top border-light mt-4">
                                                        ...
                                                        <!-- Botão -->
                                                        <button type="button" class="btn btn-primary-outline btn-small fw-700 flex-grow-1"
                                                            onclick="prefillFields({'service-name-create-<?= htmlspecialchars($encryptedPisoId) ?>': 'Informática'}); setTimeout(() => { document.getElementById('service-name-create-<?= htmlspecialchars($encryptedPisoId) ?>').dispatchEvent(new Event('input', { bubbles: true })); }, 100);">Informática</button>
                                                        <!-- Botão -->
                                                        <button type="button" class="btn btn-primary-outline btn-small fw-700 flex-grow-1"
                                                            onclick="prefillFields({'service-name-create-<?= htmlspecialchars($encryptedPisoId) ?>': 'Recursos Humanos'}); setTimeout(() => { document.getElementById('service-name-create-<?= htmlspecialchars($encryptedPisoId) ?>').dispatchEvent(new Event('input', { bubbles: true })); }, 100);">RH</button>
                                                    </div>
                                            <?php endif; ?>
                                        </form>
                                    </div>
                                            ...
                                            <div
                                                ...
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <h2 class="equipment-creation-modal-title modal-title"
                                                        ...
                                                        Eliminar Serviço</h2>
                                                    <!-- Texto -->
                                                    <span class="text-secondary fw-400">O serviço será movido para a reciclagem.</span>
                                                </div>
                                                <!-- Botão -->
                                                <button class="equipment-creation-modal-close-btn btn p-0 border-0 bg-transparent"
                                                    data-bs-dismiss="modal" aria-label="Close">
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="d-flex flex-column align-items-center gap-4">
                                                            ...
                                                            <div class="d-flex flex-column align-items-center justify-content-center gap-2 text-center">
                                                                <!-- Parágrafo -->
                                                                <p class="text-secondary">Tem a certeza que deseja apagar o
                                                ...
                                                <form method="POST" action="locations-crud/create-room.php"
                                                    ...
                                                    <?php if (SHOW_DEBUG_BUTTONS): ?>
                                                            <div class="d-flex flex-wrap gap-2 pt-2 border-top border-light mt-4">
                                                                ...
                                                                <!-- Botão -->
                                                                <button type="button" class="btn btn-primary-outline btn-small fw-700 flex-grow-1"
                                                                    onclick="prefillFields({'room-name-create-<?= htmlspecialchars($encryptedServicoId) ?>': 'Sala 101'}); setTimeout(() => { document.getElementById('room-name-create-<?= htmlspecialchars($encryptedServicoId) ?>').dispatchEvent(new Event('input', { bubbles: true })); }, 100);">Sala
                                                                    101</button>
                                                                <!-- Botão -->
                                                                <button type="button" class="btn btn-primary-outline btn-small fw-700 flex-grow-1"
                                                                    onclick="prefillFields({'room-name-create-<?= htmlspecialchars($encryptedServicoId) ?>': 'Sala 102'}); setTimeout(() => { document.getElementById('room-name-create-<?= htmlspecialchars($encryptedServicoId) ?>').dispatchEvent(new Event('input', { bubbles: true })); }, 100);">Sala
                                                                    102</button>
                                                            </div>
                                                    <?php endif; ?>
                                                </form>
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="d-flex flex-column">
                                                            ...
                                                            <h2 class="equipment-creation-modal-title modal-title"
                                                                ...
                                                                Eliminar Sala</h2>
                                                            <!-- Texto -->
                                                            <span class="text-secondary fw-400">A sala será movida para a reciclagem.</span>
                                                        </div>
                                                        <!-- Botão -->
                                                        <button class="equipment-creation-modal-close-btn btn p-0 border-0 bg-transparent"
                                                            data-bs-dismiss="modal" aria-label="Close">
