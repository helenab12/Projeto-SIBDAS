    ...
    <section class="content-container gap-6 recycling">
        ...
        <div class="d-flex justify-content-between align-items-center w-100 dashboard-title">
            <div class="d-flex flex-column gap-1">
                <h1>Reciclagem</h1>
                <p class="text-secondary fw-400">Registos removidos do sistema (Soft Delete). Pode restaurar ou apagar definitivamente.</p>
            </div>
        </div>

        <!-- Select de Tipos de Reciclagem -->
        <div class="bento-card d-flex gap-2 padding-1 flex-wrap">
            <button class="filter-bar-badge active d-flex align-items-center gap-2" id="type-all" onclick="changeSelectedTyoe('type-all')">
                ...
                <p>Todos</p>
                <span class="type-count d-flex align-items-center justify-content-center fw-700"><?php echo count($recycledOjects); ?></span>
            </button>
            <?php foreach ($recycleTypes as $key) : ?>
                <button class="filter-bar-badge d-flex align-items-center gap-2" id="type-<?= strtolower($key->name) ?>" onclick="changeSelectedTyoe('type-<?= strtolower($key->name) ?>')">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide">
                ...
                <div class="bento-card d-flex flex-row align-items-center justify-content-between gap-4 padding-4 recycle-card">
                    <div class="d-flex flex-wrap gap-4 justify-content-between w-100 align-items-center">
                        <div class="d-flex flex-row align-items-center gap-4">
                            <div class="recycle-type-icon d-flex align-items-center justify-content-center padding-2" style="background-color: color-mix(in srgb, <?php echo $object->type->color; ?> 10%, transparent); color: <?php echo $object->type->color; ?>;">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide">
                            ...
                            <div class="d-flex flex-column gap-1">
                                <div class="d-flex gap-2 align-items-center">
                                    ...
                                    <label class="text-uppercase d-flex align-middle" style="background-color: color-mix(in srgb, <?php echo $object->type->color; ?> 10%, transparent); color: <?php echo $object->type->color; ?>;">
                                ...
                                <div class="d-flex gap-1 text-muted align-items-center">
                                    ...
                                    <span class="fst-normal"> Removido: <?php echo $object->removedAt->format('Y-m-d'); ?> por <?php echo $object->removedBy; ?></span>
                                </div>
                            </div>
                        </div>
                        <div class="d-flex flex-row action-buttons gap-2">
                            <button class="btn btn-small text-success d-flex align-items-center gap-2 restore">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-undo2-icon lucide-undo-2">
                                    <path d="M9 14 4 9l5-5" />
                                    <path d="M4 9h10.5a5.5 5.5 0 0 1 5.5 5.5a5.5 5.5 0 0 1-5.5 5.5H11" />
                                </svg>
                                <span class="fw-700">Restaurar</span>
                            </button>
                            <button class="btn btn-small text-danger d-flex align-items-center gap-2 delete" data-bs-toggle="modal" data-bs-target="#delete-confirm-modal">
